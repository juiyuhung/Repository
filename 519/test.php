						...
						<nav id="nav">
							<!--
								...
								2. Standard link (sends the user to another page/site)
								   ...
								   <span class="icon fa-home">  class="icon fa-th"  class="icon fa-user"   class="icon fa-envelope"
							...
							<table style="border:3px #cccccc solid;" border="1" cellpadding="10">
								...
								<tbody>
									<tr>
										<td colspan = "3">
                                            <div>
                                            開門(至計中拿鑰匙；主顧318簽到) 先解除保全(316、318、322、324)
                                            </div>
                                        </td>
                                        <td></td>
									</tr>
